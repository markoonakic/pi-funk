...
If `$VAULT_ROOT/$TEMPLATES_DIR/new person template.md` already exists, leave it alone — the user may have customized it.

Otherwise, ask before creating a minimal person template. Create it inline; this repo does not currently ship shared template files.
